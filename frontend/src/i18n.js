    ...
    en: {
        translation: {
            ...
            "home": {
                ...
                "identify_desc": "Not sure about a medicine name? Scan its barcode or take a photo to get full clinical details instantly.",
                "verify": "Safety Check",
                "verify_desc": "Verify if a medicine you have is the one actually prescribed by your doctor to avoid mistakes.",
    ...
    hi: {
        translation: {
            "app": {
                ...
                "verify_tablet": "दवा सत्यापित करें",
                "history": "इतिहास",
                "profile": "प्रोफ़ाइल",
            ...
            "home": {
                ...
                "read": "पर्चे पढ़ें",
                "read_desc": "अपने डॉक्टर की लिखावट की फोटो लें। हमारा AI इसे पढ़ेगा और समझाएगा।",
                "identify_desc": "क्या आपको दवा का नाम पता नहीं है? विवरण प्राप्त करने के लिए उसका बारकोड स्कैन करें या फोटो लें।",
                "verify": "सुरक्षा जांच",
                "verify_desc": "गलतियों से बचने के लिए जांचें कि क्या यह दवा आपके डॉक्टर द्वारा सुझाई गई है।",
    ...
    mr: {
        translation: {
            ...
            "home": {
                ...
                "identify_desc": "औषधाचे नाव माहित नाही? त्याचा बारकोड स्कॅन करा किंवा पूर्ण माहितीसाठी फोटो घ्या.",
                "verify": "सुरक्षा तपासणी",
                "verify_desc": "एखादे औषध तुमच्या डॉक्टरांनी प्रिस्क्राइब केलेले आहे की नाही हे तपासा.",
